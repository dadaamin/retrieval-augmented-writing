"""
Patched version of Ollama to allow unsigned https traffic (https://github.com/run-llama/llama_index/blob/main/llama-index-integrations/llms/llama-index-llms-ollama/llama_index/llms/ollama/base.py).
"""
...
class Ollama(CustomLLM):
    ...
    def chat(self, messages: Sequence[ChatMessage], **kwargs: Any) -> ChatResponse:
        ...
        with httpx.Client(
            timeout=Timeout(self.request_timeout), verify=False
        ) as client:
